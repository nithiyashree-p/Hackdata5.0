...
import com.example.learngeo.HomePage;
import com.example.learngeo.Login;
import com.example.learngeo.MainActivity;
...
public class Course extends Fragment implements BackPressedListener {
    ...
    private void getData() {
        StringRequest stringRequest = new StringRequest(Request.Method.GET, config.MAIN__URL+"courses.json",
                ServerResponse -> {
